...
function main() {
    const input = '我的名字叫JameBruce,我的github地址是：github.com/mrslimslim, 我的电话号码是13550004893或者18550004835,以及13550004893,我的邮箱地址是jamebruce89@gmail.com，我的博客地址是https://mmblog.com。';
    const rules = [{
      type: 'name',
      reg: /JameBruce/g,
      replace(){
